// Ported from reactbits.dev (TargetCursor-TS-CSS). One addition: an onSnap
// callback fired at the moment the cursor locks onto a target, used to play
// the click sound — everything else is the sourced logic, unmodified.
